...
public class EchoServer {
  ...
  private void start() throws IOException {
    ...
    server = ServerBuilder.forPort(port)
            //add = list, services that our server is able to handle
        .addService(new EchoImpl()) //builder and add a bunch of servers to i//
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    //!!!
    final EchoServer server = new EchoServer(port); //setting port field
    server.start(); //starting a thread
