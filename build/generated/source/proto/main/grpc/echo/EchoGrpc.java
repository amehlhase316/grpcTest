...
@javax.annotation.Generated(
    ...
    comments = "Source: echomessage.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class EchoGrpc {

  private EchoGrpc() {}

  public static final String SERVICE_NAME = "echomessage.Echo";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<echo.ClientRequest,
      echo.ServerResponse> getParrotMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "parrot",
      requestType = echo.ClientRequest.class,
      responseType = echo.ServerResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<echo.ClientRequest,
      echo.ServerResponse> getParrotMethod() {
    io.grpc.MethodDescriptor<echo.ClientRequest, echo.ServerResponse> getParrotMethod;
    if ((getParrotMethod = EchoGrpc.getParrotMethod) == null) {
      synchronized (EchoGrpc.class) {
        if ((getParrotMethod = EchoGrpc.getParrotMethod) == null) {
          EchoGrpc.getParrotMethod = getParrotMethod =
              io.grpc.MethodDescriptor.<echo.ClientRequest, echo.ServerResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "parrot"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  echo.ClientRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  echo.ServerResponse.getDefaultInstance()))
  ...
  public static abstract class EchoImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void parrot(echo.ClientRequest request,
        io.grpc.stub.StreamObserver<echo.ServerResponse> responseObserver) {
  ...
  public static final class EchoBlockingStub extends io.grpc.stub.AbstractBlockingStub<EchoBlockingStub> {
    ...
    /**
     */
    public echo.ServerResponse parrot(echo.ClientRequest request) {
  ...
  public static final class EchoFutureStub extends io.grpc.stub.AbstractFutureStub<EchoFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<echo.ServerResponse> parrot(
        echo.ClientRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PARROT:
          serviceImpl.parrot((echo.ClientRequest) request,
              (io.grpc.stub.StreamObserver<echo.ServerResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class EchoBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return echo.EchoProto.getDescriptor();
    }
